    ...
    const handleLogin = async (signinData) => {
        ...
        try {
            ...
            if (error) {
                ...
                toast.success(`Welcome back, ${data?.user?.name || "Driver"}`);
                ...
                <div className="hidden lg:flex flex-col justify-between p-12 bg-zinc-950 text-white relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-zinc-900/80 border border-red-500/30 rounded-md mb-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)]">
                            ...
                            <span className="text-[10px] uppercase tracking-[0.3em] text-red-500 font-mono font-bold">Driver Access</span>
                        </div>
                        ...
                        <p className="text-base text-zinc-400 leading-relaxed max-w-sm">
                            Your fleet, your trips, your earnings — all in one dashboard. Sign in to hit the road.
                        </p>
                    </div>
                    <div className="relative z-10 grid grid-cols-3 gap-2">
                        <div className="bg-zinc-900/60 border border-zinc-800 rounded p-3 text-center shadow-[inset_0_2px_4px_rgba(0,0,0,0.5)]">
                            <div className="text-lg font-black text-red-500 font-mono">12K+</div>
                            <div className="text-[8px] font-mono text-zinc-500 uppercase tracking-wider mt-1">Drivers</div>
                        </div>
                        <div className="bg-zinc-900/60 border border-zinc-800 rounded p-3 text-center shadow-[inset_0_2px_4px_rgba(0,0,0,0.5)]">
                            <div className="text-lg font-black text-red-500 font-mono">50+</div>
                            <div className="text-[8px] font-mono text-zinc-500 uppercase tracking-wider mt-1">Cities</div>
                        </div>
                        <div className="bg-zinc-900/60 border border-zinc-800 rounded p-3 text-center shadow-[inset_0_2px_4px_rgba(0,0,0,0.5)]">
                            <div className="text-lg font-black text-green-400 font-mono">4.9</div>
                            <div className="text-[8px] font-mono text-zinc-500 uppercase tracking-wider mt-1">Rating</div>
                        </div>
                    </div>
                </div>

                <div className="p-8 md:p-12 lg:p-14 flex flex-col justify-center bg-white relative">
                    ...
                    <div className="mb-8">
                        ...
                        <h1 className="text-3xl md:text-4xl font-black text-zinc-900 uppercase leading-[0.95] tracking-tight mb-2">
                            Member <span className="text-red-600">Login</span>
                        </h1>
                    ...
                    <form onSubmit={handleSubmit(handleLogin)} className="flex flex-col gap-5">
                        <div>
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="w-full pl-11 pr-4 h-13 py-3 bg-zinc-50 border-2 border-zinc-200 rounded-xl focus:outline-none focus:border-red-500 focus:bg-white transition-all text-sm font-medium placeholder:text-zinc-400"
                                    required
                                />
                            </div>
                        ...
                        <div>
                            <div className="flex justify-between items-center mb-2">
                                <label className="block text-[10px] font-mono font-bold uppercase tracking-[0.3em] text-zinc-700">Password</label>
                                <a className="text-[10px] font-mono uppercase tracking-wider text-red-600 font-bold hover:text-red-700 transition-colors">
                                    Forgot?
                                </a>
                            </div>
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="w-full pl-11 pr-12 h-13 py-3 bg-zinc-50 border-2 border-zinc-200 rounded-xl focus:outline-none focus:border-red-500 focus:bg-white transition-all text-sm font-medium placeholder:text-zinc-400"
                                    required
                                />
                                <button
                                    type="button"
                        ...
                        >
                            <div className="relative px-6 py-3.5 bg-linear-to-b from-red-500 to-red-700 rounded-xl shadow-[inset_0_1px_0_rgba(255,255,255,0.3)] shadow-red-600/30 flex items-center justify-center gap-2.5 border border-red-800/50 overflow-hidden">
                                ...
                                {loading ? (
                                    ...
                                    <>
                                        <LogIn size={16} className="relative text-white drop-shadow-md" strokeWidth={3} />
                    ...
                    <div className="flex items-center gap-4 my-6">
                        ...
                        <span className="text-[10px] font-mono uppercase tracking-[0.3em] text-zinc-400 font-bold">Or Continue With</span>
                        <div className="flex-1 h-px bg-zinc-200"></div>
                    </div>
                    <button 
