...
const BookingCard = ({ booking, onCancel, index }) => {
    ...
    return (
        <div className="group relative animate-[cardReveal_0.6s_cubic-bezier(0.34,1.2,0.64,1)_both] bg-white rounded-2xl overflow-hidden border transition-all duration-300 border-zinc-200 hover:border-red-300 hover:shadow-xl hover:shadow-red-500/10"
